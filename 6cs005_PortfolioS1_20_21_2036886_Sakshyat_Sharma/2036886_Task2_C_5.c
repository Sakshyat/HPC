...
/******************************************************************************
  ...
  Compile with:
    cc -o CrackSS47 CrackSS47.c -lcrypt -pthread 

  If you want to analyse the output then use the redirection operator to send
  output to a file that you can view using an editor or the less utility:
    ./CrackSS47 > output.txt

  Dr Kevan Buckley, University of Wolverhampton, 2018 Modified by Dr. Ali Safaa 2019
******************************************************************************/

char *encrypted_password = "$6$AS$3tO1nv6UTBEiADlwQasACiyiFj4dZIhd/hkyeBXiYaBMgrHx4HzSiDMhDzqM/C1dtGFfvqNSCEasynunym83T/";
/**
